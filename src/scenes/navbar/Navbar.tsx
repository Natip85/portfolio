  ...
  return (
    <nav className={navbarBackground}>
      ...
      {isAboveMediumScreens ? (
        ...
        <button className="menu-btn" onClick={()=> setIsMenuToggled(!isMenuToggled)}>
      ...
      {!isAboveMediumScreens && isMenuToggled && (
        <>
        <div className="menu">
          <div className="menu-close-btn-wrap">
            <button className="menu-close-btn" onClick={()=> setIsMenuToggled(!isMenuToggled)}>
             x
            </button>
          </div>
